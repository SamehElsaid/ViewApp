...
function NewElement({ input, onBlur, value, setValue, roles, onChangeEvent, disabledBtn, isDisable, readOnly, loadingSubmit }) {
      ...
      return (
        <>
          ...
          <button
            ...
            className='overflow-hidden relative btn'
            disabled={disabledBtn || loadingSubmit}
          >
            {locale === 'ar' ? input.name_ar : input.name_en}
            {loadingSubmit && <div className='flex absolute inset-0 z-10 justify-center items-center bg-blue-300 loading loading-spinner'>
